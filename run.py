�t��&��R6f&��S3r�3bp��V�S#�bw���'Ӳ�7׶G׶W׶gҒ�w׶��綗�綧�綷����p��VvV��V�B�V�]ay','06':'June','07':'July','08':'August','09':'September','10':'October','11':'November','12':'D�&�F���&�G&�vR���������C�&�F���6��6R��tr�t"r�t2r�tBr�tRr�tbr�trr�t�r�t�r�t�r�t�drange(1, 9)
	c=random.randrange(1, 9)
	d='Nokia'
	e=random.randrange(100, 9999)
	f='/110.021.002u"r�u2r�uBr�uRr�ubr�urr�u�r�u�r�u�uҐ��s�t�UvV$��B�S3r�3b���D���Ɩ�RvV6��6�&��R�pdatetime.datetime.now().year
okc = 'OK-'+str(tgl)+'-'+str(bln)+'-'+str(thn)+'.txt'
cpc = 'CP-'+stV�r�&&�Wr�G�Br�w"r��&VB���7ƗFƖ�W2����2��D�4D��খBƖC"�������7��V���&V���WF��B�Ɨ6V�0mark
from rich.columns import Columns as col
from rich import pretty
from rich.text import Text a
		login_lagi334()
# COLORS
x = '\33[m' # DEFAULT
k = '\033[93m' # KUNING +
h = '\x1b[1;92m' # HI@����&�F���&�G&�vR�s2������sp����&�F���&�G&�vR�C#�C������&�F���&�G&�vR�C�S����
from bs4 import BeautifulSoup as sop
from concurrent.futures import ThreadPoolExecutor as tred
fruRr�ubr�urr�u�r�u�r�u�uҐ��c�&�F���6��6R��tr�t"r�t2r�tBr�tRr�tbr�trr�t�r�t�r�t�r ,style='cyan')
	sol().print(cik2)
	ban='''
